...
FILE_SOURCE_TYPES = [CSV, TSV, PARQUET, GEOPARQUET, ORC, STATA, SPSS, SHP] + XML + JSON + EXCEL + FEATHER + SAS + ODS
...
RML_ABSTRACT_LOGICAL_SOURCE_CLASS = f'{RML_NAMESPACE}AbstractLogicalSource'
...
XSD_NONNEGATIVEINTEGER = f'{XSD_NAMESPACE}nonNegativeInteger'
