...
FILE_SOURCE_TYPES = [CSV_SOURCE_TYPE, TSV_SOURCE_TYPE, EXCEL_SOURCE_TYPE, PARQUET_SOURCE_TYPE, FEATHER_SOURCE_TYPE,
                     ORC_SOURCE_TYPE, STATA_SOURCE_TYPE, SAS_SOURCE_TYPE, SPSS_SOURCE_TYPE, JSON_SOURCE_TYPE,
                     XML_SOURCE_TYPE]
DATA_SOURCE_TYPES = [RDB_SOURCE_TYPE] + FILE_SOURCE_TYPES
